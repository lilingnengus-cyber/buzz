...
## Installed acceptance — 2026-09-22

User completed login. Verified actual LifeOS dashboard with five focus actions. Confirmed installed executable still matches the release hash above. Issued a graceful quit; process changed from PID 63537 to 89180. Opened Life Dock after restart without clicking login/reconnect/refresh, and the dashboard loaded normally. Server recorded replacement Workbench session `d0c8548c-3146-4daf-b345-deacc04129ea` at 14:58:16.285555 Asia/Shanghai, expiring 15:54:23. This verifies credential recovery across a real process restart. It does not yet verify unattended expiry renewal. Reused the existing LifeOS heartbeat for a read-only check at 15:56, with instructions to pause after reporting its result.
