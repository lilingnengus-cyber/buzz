CREATE TABLE business_agent_order_cancellation_intents (
 id uuid PRIMARY KEY,
 kind text NOT NULL CHECK(kind IN ('sales_order_cancellation_intent','purchase_order_cancellation_intent')),
...
FROM (VALUES ('sales_order_cancellation_intent','create'),('sales_order_cancellation_intent','approve'),('purchase_order_cancellation_intent','create'),('purchase_order_cancellation_intent','approve')) AS capability(resource,action)
