CREATE TABLE business_agent_report_snapshot_intents (
 id uuid PRIMARY KEY,
 kind text NOT NULL CHECK(kind IN ('management_report_snapshot_intent')),
...
FROM (VALUES ('management_report_snapshot_intent')) kinds(kind)
