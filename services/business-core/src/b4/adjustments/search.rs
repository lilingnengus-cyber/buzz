    ...
    async fn search_on(
        ...
        'scan: loop {
            ...
            for id in ids {
                ...
                let b = &detail["batch"];
                items.push(json!({"id":id,"adjustmentNumber":b["adjustment_number"],"legalEntityId":b["legal_entity_id"],"businessUnitIds":detail["businessUnitIds"],"currency":b["currency"],"managementPeriod":b["management_period"],"status":b["status"],"version":detail["version"],"totalAmount":detail["totalAmount"],"lineCount":detail["pagination"]["total"],"targetOrderCount":detail["targetOrderCount"],"hasUnattributedBrandTargets":detail["hasUnattributedBrandTargets"],"createdAt":b["created_at"],"updatedAt":b["updated_at"]}));
