...
use snapshot_preview::SnapshotContent;
use sqlx::Row;
use uuid::Uuid;
...
impl ProfitReportingService {
    ...
    pub async fn generate_snapshot(
        ...
        crate::snapshot_transaction::retry(|| {
            self.generate_snapshot_once(actor, trace_id, key, input, None)
        })
        .await
    }
