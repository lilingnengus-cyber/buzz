...
check_instance "$main" com.shiyueshizi.pacioli.dev ''
check_instance "$main/desktop" com.shiyueshizi.pacioli.dev ''
...
check_instance "$linked" com.shiyueshizi.pacioli.dev.feature-other other
check_instance "$linked/desktop" com.shiyueshizi.pacioli.dev.feature-other other
...
check_instance "$linked/desktop" com.shiyueshizi.pacioli.dev.head HEAD

ln -s "$main" "$tmp/main-link"
check_instance "$tmp/main-link/desktop" com.shiyueshizi.pacioli.dev ''
