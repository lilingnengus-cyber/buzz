...
// loading gate keeps the Pacioli mark up as an overlay above the already
...
test("boot splash overlay holds with an animated Pacioli mark, then dismisses", async ({
  page,
}) => {
