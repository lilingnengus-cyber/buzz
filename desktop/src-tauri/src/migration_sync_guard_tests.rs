...
fn is_dev_data_dir_name_rejects_prod_identifier() {
    assert!(!is_dev_data_dir_name("com.shiyueshizi.pacioli"));
}

#[test]
fn is_dev_data_dir_name_accepts_canonical_dev_identifier() {
    assert!(is_dev_data_dir_name("com.shiyueshizi.pacioli.dev"));
}

#[test]
fn is_dev_data_dir_name_accepts_worktree_dev_identifier() {
    assert!(is_dev_data_dir_name(
        "com.shiyueshizi.pacioli.dev.some-worktree"
    ));
}
...
/// `com.shiyueshizi.pacioli.developer` is a hypothetical prod variant, not a
/// worktree of `com.shiyueshizi.pacioli.dev`.
#[test]
fn is_dev_data_dir_name_rejects_prefix_collision() {
    assert!(!is_dev_data_dir_name("com.shiyueshizi.pacioli.developer"));
}
